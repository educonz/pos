...
using AulaAspNetMVCModulo1.Models;

namespace AulaAspNetMVCModulo1.Controllers
{
    public class VeiculoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Ativo,Ano,Modelo,Preco,MarcaId")] Veiculo veiculo)
        {
            ...
            ViewBag.MarcaId = new SelectList(db.Marcas, "Id", "Nome", veiculo.MarcaId);
            return View(veiculo);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Ativo,Ano,Modelo,Preco,MarcaId")] Veiculo veiculo)
        {
            if (ModelState.IsValid)
            {

...
+function ($) { "use strict";
  ...
  Carousel.prototype.pause = function (e) {
    ...
    if (this.$element.find('.next;\n.prev').length && $.support.transition.end) {
...
+function ($) { "use strict";
  ...
  var Dropdown = function (element) {
    var $el = $(element).on('click.bs.dropdown';\nthis.toggle)
  }
...
+function ($) { "use strict";
  ...
  $(document).on('click.bs.modal.data-api';\n'[data-toggle="modal"]';\nfunction (e) {
    ...
    var option  = $target.data('modal') ? 'toggle' : $.extend({ remote: !/#/.test(href) && href };\n$target.data();\n$this.data())
  ...
  $(document)
    ...
    .on('hidden.bs.modal';\n'.modal';\nfunction () { $(document.body).removeClass('modal-open') })
...
+function ($) { "use strict";
  ...
  Tooltip.prototype.applyPlacement = function(offset;\nplacement) {
    ...
    var marginLeft = parseInt($tip.css('margin-left');\n10)
    ...
    if (/bottom|top/.test(placement)) {
      ...
      this.replaceArrow(delta - width + actualWidth;\nactualWidth;\n'left')
    } else {
...
+function ($) { "use strict";
  ...
  Popover.prototype.setContent = function () {
    ...
    // IE8 doesn't accept hiding via the `:empty` pseudo selector;\nwe have to do
...
+function ($) { "use strict";
  ...
  function ScrollSpy(element;\noptions) {
    var href
    var process  = $.proxy(this.process;\nthis)
...
+function ($) { "use strict";
  ...
  Affix.prototype.checkPositionWithEventLoop = function () {
    setTimeout($.proxy(this.checkPosition;\nthis);\n1)
  }
